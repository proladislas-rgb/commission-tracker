...
export default function ReconnectGoogleBanner({
  ...
  return (
    <div className="bg-[rgba(240,163,60,0.13)] border border-[rgba(240,163,60,0.26)] rounded-2xl px-4 py-3 flex items-center gap-3">
      <svg className="w-5 h-5 text-lg-warning flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z" />
      </svg>
      <p className="text-lg-warning text-sm flex-1">{message}</p>
      <button
        onClick={handleClick}
        disabled={loading}
        className="text-lg-warning text-sm font-semibold hover:underline flex-shrink-0 disabled:opacity-50 disabled:cursor-not-allowed"
      >
