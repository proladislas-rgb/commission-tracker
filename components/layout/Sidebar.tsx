...
const NAV_ICONS: Record<string, React.ReactNode> = {
  ...
  '/dashboard/agent': (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <rect x="3" y="11" width="18" height="10" rx="2"/><path d="M12 2a4 4 0 014 4v5H8V6a4 4 0 014-4z"/><circle cx="9" cy="16" r="1" fill="#10b981" stroke="none"/><circle cx="15" cy="16" r="1" fill="#10b981" stroke="none"/>
    </svg>
  ),
}
        ...
        {NAV_ITEMS.map(item => {
          ...
          return (
            ...
            >
              ...
              {item.href === '/dashboard/agent' && !collapsed && (
                <span style={{
                  marginLeft: 'auto',
